...
int l[MAX],last;
int start,flag;
int crossedge[50][2],missedge[100][2],h,z,found;
...
// suppose u-v is edge
//for each neighbor u check all the neighbors of v whether they are adjacent 
void check4()
{
 int a,b,truth=0;
 cout<<"h : "<<h<<endl;
...
//suppose u-v is edge
//are there any common neighbor for u anv v ??
